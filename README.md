...
fail: Microsoft.EntityFrameworkCore.Database.Command[20102]
      Failed executing DbCommand (362ms) [Parameters=[], CommandType='Text', CommandTimeout='30']
      ALTER TABLE public."Departments" ALTER COLUMN id TYPE text;
      ALTER TABLE public."Departments" ALTER COLUMN id DROP IDENTITY;
      COMMENT ON COLUMN public."Departments".id IS NULL;
Failed executing DbCommand (362ms) [Parameters=[], CommandType='Text', CommandTimeout='30']
ALTER TABLE public."Departments" ALTER COLUMN id TYPE text;
ALTER TABLE public."Departments" ALTER COLUMN id DROP IDENTITY;
COMMENT ON COLUMN public."Departments".id IS NULL;
Npgsql.PostgresException (0x80004005): 22023: типом столбца идентификации может быть только smallint, integer или bigint
  ...
  Exception data:
    Severity: ОШИБКА
    SqlState: 22023
    MessageText: типом столбца идентификации может быть только smallint, integer или bigint
    File: sequence.c
    Line: 1384
    Routine: init_params
22023: типом столбца идентификации может быть только smallint, integer или bigint
...
namespace BpmBaseApi.Domain.Entities.Event.Reference;
...
namespace BpmBaseApi.Persistence.Configurations.Entities.Reference;
