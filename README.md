...
fail: Microsoft.EntityFrameworkCore.Database.Command[20102]
      Failed executing DbCommand (342ms) [Parameters=[], CommandType='Text', CommandTimeout='30']
      ALTER TABLE public."Departments" ALTER COLUMN actual TYPE integer;
Failed executing DbCommand (342ms) [Parameters=[], CommandType='Text', CommandTimeout='30']
ALTER TABLE public."Departments" ALTER COLUMN actual TYPE integer;
Npgsql.PostgresException (0x80004005): 42804: столбец "actual" нельзя автоматически привести к типу integer
  ...
  Exception data:
    Severity: ОШИБКА
    SqlState: 42804
    MessageText: столбец "actual" нельзя автоматически привести к типу integer
    Hint: Возможно, необходимо указать "USING actual::integer".
    File: tablecmds.c
    Line: 12941
    Routine: ATPrepAlterColumnType
42804: столбец "actual" нельзя автоматически привести к типу integer
