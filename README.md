Есть момент что нужно импраить в Rework Update тоже files там может быть  2 файла и в доработке добавить 3 и она 5 может стать именно файлы а может 1 удалить добавить3 тогда 4 итд имеенно файлы как то тоже чтоб работало  "files": [
    {
