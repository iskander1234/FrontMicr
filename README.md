Запрос лител но этот запрос не смотрит на classification потому что это другой маршрут а ошибка такая 

{
  "data": null,
  "message": "Не удалось определить classification (ожидается Emergency|Standard|Normal).",
  "errorCode": 1001
}

Сам запрос такой 
{
    "taskId": "7cfd3243-0fbe-4fa2-ac25-40519428f9bc",
    "action": "Submit",
    "condition": "accept",
