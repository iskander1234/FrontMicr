Ругается на   Stage         = ProcessStage.Acquaintance.ToString() нет Stage и потом давай сделаем Status Notify и чтоб она работала как Pending  using System.Text.Json;
