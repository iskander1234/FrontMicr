Есть момент что нужно испраить в Rework Update именно PayloadJson тоже files там может быть  2 файла и в доработке добавить 3 и она 5 может стать именно файлы а может 1 удалить добавить3 тогда 4 итд имеенно файлы как то тоже чтоб работало  "files": [
    {
      "fileId": "e315f1f3-e2a3-4468-9e88-91b49d649d7d",
